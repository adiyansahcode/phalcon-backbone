 ...
 */
class TypeModel extends \Phalcon\Mvc\Model
{
     ...
     * @return TypeModel
     */
    public function setId(int $id): TypeModel
    {
        $this->id = $id;
     ...
     * @return TypeModel
     */
    public function setCreatedAt(string $createdAt): TypeModel
    {
     ...
     * @return TypeModel
     */
    public function setUpdatedAt(string $updatedAt): TypeModel
    {
     ...
     * @return TypeModel
     */
    public function setName(string $name): TypeModel
    {
        $this->name = $name;
     ...
     * @return TypeModel
     */
    public function setDescription(string $description): TypeModel
    {
     ...
     * @return TypeModel
     */
    public function setIsActive(string $isActive): TypeModel
    {
